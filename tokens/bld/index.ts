...
const TOKEN_NAME = "Jolly Roger";
const TOKEN_SYMBOL = "JLR";
const TOKEN_DESCRIPTION = "A token for the Era of Pirates";
const TOKEN_IMAGE_NAME = "piratenft.png"; // Replace unicorn.png with your image name
